...
abstract class AppLocalizations {
  ...
  /// Default name of a rest day in a split.
  ///
  /// In en, this message translates to:
  /// **'Rest'**
  String get restDayLabel;

  /// Meta line under a rest day in a split, where a workout day shows its exercise count.
  ///
  /// In en, this message translates to:
  /// **'Rest day'**
  String get restDayMeta;

  /// Day-type choice when adding a day to a split: a training day.
  ///
  /// In en, this message translates to:
  /// **'Workout'**
  String get planDayTypeWorkout;

  /// Day-type choice when adding a day to a split: a scheduled rest day.
  ///
  /// In en, this message translates to:
  /// **'Rest day'**
  String get planDayTypeRest;

  /// Quiet action under Start on today's workout card: the user chooses to rest today instead. The plan is not changed.
  ///
  /// In en, this message translates to:
  /// **'Take a rest day'**
  String get restDayTake;

  /// Caption on the rest-day card.
  ///
  /// In en, this message translates to:
  /// **'REST DAY'**
  String get restDayCaps;

  /// Title of the rest-day card when the split schedules rest today.
  ///
  /// In en, this message translates to:
  /// **'Today\'s rest day'**
  String get restDayTitle;

  /// ZIVO's line on a planned rest day.
  ///
  /// In en, this message translates to:
  /// **'Recovery is part of your training.'**
  String get restDayBody;

  /// Title of the rest-day card when the user chose to rest instead of the planned workout.
  ///
  /// In en, this message translates to:
  /// **'You chose to rest today'**
  String get restDayChosenTitle;

  /// ZIVO's line on a rest day the user chose.
  ///
  /// In en, this message translates to:
  /// **'Recovery is part of the plan.'**
  String get restDayChosenBody;

  /// Caption above the next workout on the rest-day card.
  ///
  /// In en, this message translates to:
  /// **'UP NEXT'**
  String get restDayNextSession;

  /// The next workout on the rest-day card: its name and its exercise count.
  ///
  /// In en, this message translates to:
  /// **'{day} · {meta}'**
  String restDayNextLine(String day, String meta);

  /// Opens the next workout's details from the rest-day card.
  ///
  /// In en, this message translates to:
  /// **'View next workout'**
  String get restDayViewNext;

  /// Starts the next workout on a planned rest day. Recorded as an extra session.
  ///
  /// In en, this message translates to:
  /// **'Train anyway'**
  String get restDayTrainAnyway;

  /// Withdraws the user's choice to rest today, bringing back today's workout.
  ///
  /// In en, this message translates to:
  /// **'Resume today\'s workout'**
  String get restDayResume;
}
