...
/// location is captured unless the user adds it.
class MomentCapturePage extends StatefulWidget {
  const MomentCapturePage({super.key});
...
class _MomentCapturePageState extends State<MomentCapturePage> {
  ...
  Future<void> _save() async {
    ...
    await AppScope.of(context).moments.add(moment);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            CaptureTopBar(title: 'New moment', onClose: () => Navigator.of(context).maybePop()),
            Padding(
